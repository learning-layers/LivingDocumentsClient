...
let externalDataMethod = function(filterString, sortColumn, sortAscending, page, pageSize, callback) {
    ...
    let uri = "/api/documents/" + documentIdWrapper.documentId + "/attachment?attachment-types=all&excluded-attachment-types=image%2Fpng%3Bimage%2Fjpeg&page-number=" + page + "&page-size=" + pageSize + "&sort-direction=DESC&sort-property=createdAt";
