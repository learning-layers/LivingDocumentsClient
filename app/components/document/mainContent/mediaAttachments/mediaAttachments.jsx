...
import MediaAttachmentModel from "./mediaAttachmentModel.js";
...
let OptionsComponent = React.createClass({
    ...
    render: function() {
        ...
        let documentWrapper = MediaAttachmentModel.getDocumentWrapper();
        return (
...
let MediaAttachments = React.createClass({
    getInitialState() {
        MediaAttachmentModel.setDocumentId(this.props.document.id);
        return {
            uploadAreaOpened: false
        };
    },
    componentWillReceiveProps(nextProps) {
        MediaAttachmentModel.setDocumentId(nextProps.document.id);
    },
    toggleUploadArea() {
        this.setState({
            ...
            <div id="file-attachments">
                <div className="uploaded-files">
                    <GriddleWithCallback onRowClick={this.handleClick}
                                         getExternalResults={MediaAttachmentModel.externalDataMethod} loadingComponent={Loading}
