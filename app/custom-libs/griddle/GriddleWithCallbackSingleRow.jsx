...
let GriddleWithCallbackSingleRow = React.createClass({
    /**
     *
     */
    getDefaultProps: function(){
    ...
    updateStateWithExternalResults: function(state, callback) {
        ...
        this.getExternalResults(state, function(externalResults) {
            ...
            if (that.props.enableInfiniteScroll && that.state.results) {
                ...
                console.debug(state.results);
                state.results = _.sortBy(state.results, function(o) {
                    return o.comment.createdAt;
                }).reverse();
            } else {
...
module.exports = GriddleWithCallbackSingleRow;