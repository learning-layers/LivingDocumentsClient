module.exports = function (grunt) {
    ...
    grunt.registerTask('build', [
        ...
        'concat:build_css', 'copy:build_app_assets', 'copy:build_app_fonts', 'copy:build_app_templates', 'copy:build_vendor_assets',
    ...
    grunt.registerTask('compile', [
        'less:compile', 'copy:compile_assets', 'copy:compile_fonts', 'copy:compile_templates', 'ngmin', 'concat:compile_js', 'uglify', 'index:compile'
    ]);
